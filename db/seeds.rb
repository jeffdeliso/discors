...
stark = guest.admin_servers.create!(name: 'stark')
...
targaryen = guest.admin_servers.create!(name: 'targaryen')
...
baratheon = guest.admin_servers.create!(name: 'baratheon')
...
lannister = guest.admin_servers.create!(name: 'lannister')
...
tyrell = guest.admin_servers.create!(name: 'tyrell')
...
tully = guest.admin_servers.create!(name: 'tully')
...
martell = guest.admin_servers.create!(name: 'martell')
...
greyjoy = guest.admin_servers.create!(name: 'greyjoy')
...
arryn = guest.admin_servers.create!(name: 'arryn')
