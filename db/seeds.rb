...
guest = User.create!(username: 'guest', email: 'guest@guest.com', password: '111111')
...
ServerMembership.create!(user_id: guest.id, server_id: stark.id)
...
ServerMembership.create!(user_id: guest.id, server_id: targaryen.id)
...
ServerMembership.create!(user_id: guest.id, server_id: baratheon.id)
...
ServerMembership.create!(user_id: guest.id, server_id: lannister.id)
...
ServerMembership.create!(user_id: guest.id, server_id: tyrell.id)
...
ServerMembership.create!(user_id: guest.id, server_id: tully.id)
...
ServerMembership.create!(user_id: guest.id, server_id: martell.id)
...
ServerMembership.create!(user_id: guest.id, server_id: greyjoy.id)
...
ServerMembership.create!(user_id: guest.id, server_id: arryn.id)
