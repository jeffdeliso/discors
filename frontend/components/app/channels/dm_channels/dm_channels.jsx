...
function DMChannels(props) {
  const channels = props.channels.map((channel, idx) => {
    ...
    return <DmChannel
      ...
      key={idx}
      deleteDmChannel={() => props.deleteDmChannel(channel.id)}
      removeDmNotification={props.removeDmNotification}
    />;
  });
    ...
    <div className="right-main">
      <div className="channels">
        ...
        >
          ...
          {props.requestCount ? <div className="friends-request-counter">{props.requestCount}</div> : null}
        </NavLink>
